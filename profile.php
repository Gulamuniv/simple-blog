...
<?php
    $SearchQueryParameter = $_GET["username"];
     ...
     $sql = "SELECT aname,aheadline,abio,aimage FROM admins 
            WHERE username='{$SearchQueryParameter}'";
   $resultAray  = mysqli_query($conn, $sql) or die('could not connect!');
  
if(mysqli_num_rows($resultAray)==1){
  while ($data    =mysqli_fetch_assoc($resultAray)) {
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a href="#" class="navbar-brand text-uppercase"> gulamkhan.COM</a>
