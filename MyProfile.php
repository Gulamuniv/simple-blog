...
while ($data =mysqli_fetch_assoc($results)) {
  $ExistingName     = $data['aname'];
  $ExistingUsername = $data['username'];
  $ExistingHeadline = $data['aheadline'];
  $ExistingBio      = $data['abio'];
  $ExistingImage    = $data['aimage'];
}
...
if(isset($_POST["Submit"])){
  ...
  if (empty($AName)|| empty($AHeadline)||empty($ABio)) {
    $_SESSION["ErrorMessage"] = "All Fields are Require!";
    Redirect_to("MyProfile.php");
  }
 elseif(strlen($AHeadline)>40) {
    $_SESSION["ErrorMessage"] = "Headline Should be less than 40 characters";
    Redirect_to("MyProfile.php");
...
<head>
  ...
  <link  rel="stylesheet" href="textarea/editor.css">
      ...
      <form class="" action="MyProfile.php" method="post" enctype="multipart/form-data">
        <div class="card bg-dark text-light">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
            <textarea id="txtEditor" placeholder="Bio" name="Bio" ></textarea>
            </div> 
