      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          ...
          <table class="table table-striped table-hover">
            ...
            <?php 
          $query = "SELECT * FROM posts ORDER BY id desc LIMIT 0,6";
          $results = mysqli_query($conn, $query)or die('could not connect');
          $sn =0;
            ...
            <tbody>
            	<tr>
            		...
            		<td><?php echo $Autor; ?></td>
                     <td>
                   <?php 
                    $TotalComments = ApproveCommnetAsPosts($PostId);
                    if ($TotalComments>0) {
                 ...
                 ?>
                       ...
                       <?php 
                          $TotalDisComments = DisApproveCommnetById($PostId);
                            if ($TotalDisComments) {
